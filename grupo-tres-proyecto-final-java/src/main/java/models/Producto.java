...
public class Producto {
    ...
    //Constructores.
    public Producto() { }
    public Producto(Long codigo_producto, String nombre_producto, double precio_producto, String descripcion_producto) {
    ...
    public Producto(String nameProduct, double priceProduct, String description) {
        this.nombre_producto = nameProduct;
        this.precio_producto = priceProduct;
        this.descripcion_producto = description;
    }
