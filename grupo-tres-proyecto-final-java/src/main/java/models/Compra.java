...
public class Compra {
    ...
    //Constructores.
    public Compra() { }
    public Compra(long dni_comprador, long codigo_producto_compra, int cantidad_producto, boolean esta_pagada, double total_compra) {
    ...
    public Compra(Boleta boleta, long numero_compra, int cantidad_producto, boolean esta_pagada, double total_compra) {
        this.boleta = boleta;
    ...
    public double getTotal_compra() { return total_compra; }
    ...
    public void setTotal_compra(double total_compra) { this.total_compra = total_compra; }
